//-----------------------------------------------------------------------
// <copyright file="ICfgLastPrecSlotForConsSlotApt.cs" company="supix">
//
...
{
    public interface ICfgLastPrecSlotForConsSlotApt
    {
        ICfgFollowingSlotForConsSlotApt To(int slot);
    }
}