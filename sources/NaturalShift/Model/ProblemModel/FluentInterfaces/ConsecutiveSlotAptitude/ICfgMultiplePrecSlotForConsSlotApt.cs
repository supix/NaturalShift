//-----------------------------------------------------------------------
// <copyright file="ICfgMultiplePrecSlotForConsSlotApt.cs" company="supix">
//
...
{
    public interface ICfgMultiplePrecSlotForConsSlotApt
    {
        ICfgLastPrecSlotForConsSlotApt From(int slot);
    }
}