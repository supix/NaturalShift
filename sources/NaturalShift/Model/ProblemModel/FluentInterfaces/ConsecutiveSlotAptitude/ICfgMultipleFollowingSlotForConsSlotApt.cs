//-----------------------------------------------------------------------
// <copyright file="ICfgMultipleFollowingSlotForConsSlotApt.cs" company="supix">
//
...
{
    public interface ICfgMultipleFollowingSlotForConsSlotApt
    {
        ICfgLastFollowingSlotForConsSlotApt From(int slot);
    }
}