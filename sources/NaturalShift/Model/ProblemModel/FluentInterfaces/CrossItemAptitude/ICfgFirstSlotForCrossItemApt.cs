//-----------------------------------------------------------------------
// <copyright file="ICfgFirstSlotForCrossItemApt.cs" company="supix">
//
...
{
    public interface ICfgFirstSlotForCrossItemApt
    {
        ICfgAptitudeForCrossItemApt CoversSlot(int slot);
    }
}