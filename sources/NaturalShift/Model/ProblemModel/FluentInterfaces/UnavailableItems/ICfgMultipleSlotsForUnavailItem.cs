//-----------------------------------------------------------------------
// <copyright file="ICfgMultipleSlotsForUnavailItem.cs" company="supix">
//
...
{
    public interface ICfgMultipleSlotsForUnavailItem
    {
        ICfgLastSlotForUnavailItem From(int slot);
    }
}