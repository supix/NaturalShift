...
namespace NaturalShift.SolvingEnvironment.Chromosomes
{
    ...
    /// </para></remarks>
    //
    internal class ThreadSafeShortArrayChromosome : ChromosomeBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThreadSafeShortArrayChromosome"/> class.
        /// </summary>
        ///
        ...
        ///
        public ThreadSafeShortArrayChromosome(int length) : this(length, ushort.MaxValue) { }
        ...
        ///
        public ThreadSafeShortArrayChromosome(int length, int maxValue)
        {
            // save parameters
        ...
        ///
        protected ThreadSafeShortArrayChromosome(ThreadSafeShortArrayChromosome source)
        {
            // copy all properties
        ...
        {
            return new ThreadSafeShortArrayChromosome(length, maxValue);
        }
        ...
        {
            return new ThreadSafeShortArrayChromosome(this);
        }
        ...
        {
            ThreadSafeShortArrayChromosome p = (ThreadSafeShortArrayChromosome)pair;
